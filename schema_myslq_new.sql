...
CREATE TABLE IF NOT EXISTS `mydb`.`User_Addresses` (
  `idUser_Addresses` INT NOT NULL AUTO_INCREMENT,
  `User_id` INT NOT NULL,
  `Address_id` INT NOT NULL,
  PRIMARY KEY (`idUser_Addresses`),
  INDEX `fk_User_Addresses_Users1_idx` (`User_id` ASC) VISIBLE,
  INDEX `fk_User_Addresses_Addresses1_idx` (`Address_id` ASC) VISIBLE,
